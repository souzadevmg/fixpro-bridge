...
Fix Pro Remote (VPS)
        ...
        â–¼
Fix Pro Bridge 2.4 (Android / Termux)
        â”‚ Magic Packet UDP
        â–¼
...
Todas as versÃµes estÃ£o fixadas em `requirements.txt`. O instalador usa apenas wheels universais e nunca executa setup de cÃ³digo-fonte. Flask 3.1.3 requer Python 3.9+, Waitress Ã© um servidor WSGI puramente Python, wakeonlan 4.0 suporta Python 3.10+ e requests 2.44.2 suporta Python 3.10+.
